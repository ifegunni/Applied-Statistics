...
#	n1=10,iter=1000,mean=10,sd=4
chisq=mychisim(n1=10,sigma1 = 4,mean1 = 10, iter = 1000, ymax =0.13)
# n1 =20,iter=1000,mean=10,sd=4
chisq=mychisim(n1=20,sigma1 = 4,mean1 = 10, iter = 1000, ymax =0.08)
# n1 =100,iter=1000,mean=10,sd=4
chisq=mychisim(n1=100,sigma1 = 4,mean1 = 10, iter = 1000, ymax =0.04)
# n1 =200,iter=1000,mean=10,sd=4
chisq=mychisim(n1=200,sigma1 = 4,mean1 = 10, iter = 1000, ymax =0.04)
# n1 =1000,iter=1000,mean=10,sd=4
chisq=mychisim(n1=1000,sigma1 = 4,mean1 = 10, iter = 1000, ymax =0.02)
# n1 =10,iter=1500,mean=20,sd=10
chisq=mychisim(n1=10,sigma1 = 10, mean1 = 20, iter = 1500, ymax =0.1)
# histogram of chisq$w
hist(chisq$w,freq=FALSE, ylim=c(0,0.1), # Histogram with annotation
     main=substitute(paste("Sample size = ",n[1]," = ",n1," statistic = ",chi^2)),
     xlab=expression(paste(chi^2, "Statistic",sep=" ")) ,las=1)
...
windows()
#n1=10,iter=1000,mean1=10,sd1=4
myTsim(n1 = 10,iter =1000,mean1 =10,sd1 =4,ymax =0.5)
#n1=20,iter=1000,mean1=10,sd1=4
myTsim(n1 = 20,iter =1000,mean1 =10,sd1 =4,ymax =0.5)
#n1=100,iter=1000,mean1=10,sd1=4
myTsim(n1 = 100,iter =1000,mean1 =10,sd1 =4,ymax =0.5)
#n1=200,iter=1000,mean1=10,sd1=4
myTsim(n1 = 200,iter =1000,mean1 =10,sd1 =4,ymax =0.5)
# n1 =10,iter=1500,mean=20,sd=10
T = myTsim(n1 =10,iter =1500, mean1 = 20, sd1=10,ymax = 0.5) 
# Histogram of T$w
hist(T$w,freq=FALSE, ylim=c(0,.5), # Histogram with annotation
     main=substitute(paste("Sample size = ",n[1]," = ",n1," statistic = ",T," iterations= ",iter)),
     xlab=expression(paste(T, "Statistic",sep=" ")), las=1)
...
windows()
#n1=10,n2=10,mean1=5,mean2=10,sd1=sd2=4,iter=1000
mychisim2(n1 =10, n2 =10, mean1 = 5, mean2 = 10, sigma1 = 4,sigma2 = 4, iter = 1000)
#n1=20,n2=10,mean1=3,mean2=5,sd1=sd2=10,iter=1000
mychisim2(n1=20,n2=10,mean1=3,mean2=5,sigma1= 10,sigma2 = 10,iter = 1000)
#n1=50,n2=50,mean1=5,mean2=10,sd1=sd2=4,iter=10000
mychisim2(n1=50,n2=50,mean1=5,mean2=10,sigma1= 4,sigma2 = 4,iter = 10000)
#n1=80,n2=50,mean1=3,mean2=5,sigma1=sigma2=10,iter=10000
mychisim2(n1=80,n2=50,mean1=3,mean2=5,sigma1= 10,sigma2 = 10,iter = 10000)
# for iter =1000
mychis2 = mychisim2(iter =1000)
# Histogram
hist(mychis2$w,freq=FALSE, ylim=c(0,.1), # Histogram with annotation
     main=substitute(paste("Sample size = ",n[1]," = ",n1," statistic = ",T," iterations= ",iter)),
     xlab=expression(paste(T, "Statistic",sep=" ")), las=1)

# Task 5
# myTsim2 modified to show legend
...
# n1=20,n2=10,mean1=3,mean2=5,sigma1=sigma2=10,iter=1000
myTsim2(n1=20,n2=10,mean1=3,mean2=5,sigma1=10,sigma2=10,iter=1000)
# n1=50,n2=50,mean1=5,mean2=10,sigma1=sigma2=4,iter=10000
myTsim2(n1=50,n2=50,mean1=5,mean2=10,sigma1=4,sigma2=4,iter=10000)
# n1=80,n2=50,mean1=3,mean2=5,sigma1=10,sigma2=10,iter=10000
myTsim2(n1=80,n2=50,mean1=3,mean2=5,sigma1=10,sigma2=10,iter=10000)
# histogram for iter =10000
myT2 = myTsim2(iter = 1000)
hist(myT2$w,freq=FALSE, ylim=c(0,.5), # Histogram with annotation
     main=substitute(paste("Sample size = ",n[1]," = ",n1," statistic = ",T," iterations= ",iter)),
     xlab=expression(paste(T, "Statistic",sep=" ")), las=1)
...
# n1=50,n2=50,mean1=5,mean2=10,sigma1=2,sigma2=4,iter=10000
myFsim2(n1=50,n2=50,mean1=5,mean2=10,sigma1=2,sigma2=4,iter=10000, ymax = 1.4)
# n1=80,n2=50,mean1=3,mean2=5,sigma1=10,sigma2=20,iter=10000
myFsim2(n1=80,n2=50,mean1=3,mean2=5,sigma1=10,sigma2=20,iter=10000, ymax = 2.0)
